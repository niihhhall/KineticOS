...
// Visibility configuration to easily hide/unhide elements
const VISIBILITY_CONFIG = {
  showHeadline: false,    // Set to true to show "See Your Business In 3 Seconds..."
  showVideo: false,       // Set to true to show the video player
  showTimeline: false,    // Set to true to show the timeline segments
};
  ...
  return (
    ...
    >
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        {/* Header */}
        {VISIBILITY_CONFIG.showHeadline && (
        ...
        {VISIBILITY_CONFIG.showTimeline && (
